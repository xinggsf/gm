...
// @include    https://search.*.cf/search*
...
const router = {
	...
	google: `.rhscol,#rhs,#rhscol{display:none !important;}#cnt #center_col,#rso>div{width:90vw !important;}#kp-wp-tab-overview .g{display:inline-flex;flex-wrap:wrap;width:46%!important;padding-right:28px}#cnt #foot{width:1px !important}.vk_c{border:0px solid #dfe1e5 !important;}`,
...
router.shuu = router.iwiki = router.ecnu = router['xn--u8jta9j'] = router.google;
