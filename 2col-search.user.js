...
const router = {
	...
	bing:`#b_context{display:none}#b_content{padding:9px 15px !important} #b_results{width:99vw;display:flex;flex-wrap:wrap} #b_results>li{width:43%;margin-right:28px;}.b_pag,.b_ans{width:100% !important}`,
