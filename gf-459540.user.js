...
(function () {
	...
	let videoYear = $(isWeb ? ".year" : ".sub-original-title").innerText.slice(1, -1);
	...
	class UI {
		constructor(playList) {
			...
			e.children[0].onclick = function() {
				...
				$('#TalionNav').hidden = $('.talion-nav-footer').hidden = !1;
			};
			document.body.style.overflow = 'hidden';
			$('#TalionNav').hidden = $('.talion-nav-footer').hidden = true;
